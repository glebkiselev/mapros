...
from src.planner.scripts.mapcore.planning.mapplanner import MapPlanner

from map_spatial_wrapper.config_master import create_config, get_config
import platform
...
def main(args):
    ...
    if args.problem and args.agpath and args.agtype:
        ...
        if not args.config_path:
            path = create_config(domen='blocks', task_num = '6', delim=delim, task_type = 'pddl')
        else:
            path = args.config_path
